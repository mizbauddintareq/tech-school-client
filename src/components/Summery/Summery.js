const Summery = () => {
  return (
    <div className="bg-orange-50 dark:bg-slate-900 dark:text-white pb-16 text-slate-900">
      <div className="w-10/12 mx-auto">
        ...
        <p>
          ...
          that’s required is the curiosity and drive to learn. At Tech School,
          we are committed to empowering all people, regardless of where they
          are in their coding journeys, to continue to learn, grow, and make an
          impact on the world around them.
        </p>

        <div className="stats shadow-xl w-full bg-orange-50 border-orange-900 border dark:border-0 dark:bg-slate-200 mt-8">
          <div className="stat">
            ...
            <div className="stat-desc">
              91% got hired after finished course.
            </div>
          </div>
